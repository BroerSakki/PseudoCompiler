...
SOURCES_TOOLS = src/Directories.java src/ColoringTools.java src/StartupTools.java src/Grouper.java src/Formatter.java src/Dissector.java src/Translator.java
