...
# Source files
SOURCES = src/ConstLibrary.java src/MethodLibrary.java src/Num.java src/Directories.java src/ColoringTools.java src/Formatter.java src/Dissector.java src/Main.java
MAIN = src.core.Main
