...
public interface StatementLibrary {
    ...
    // Keyword list
    String[] KEYS_STATEMENT_TYPE = {KEY_START, KEY_STOP, KEY_RETURN, KEY_WHILE, KEY_ENDWHILE, KEY_FOR, KEY_ENDFOR, KEY_IF, KEY_ELSE, KEY_ELSE_IF, KEY_ENDIF, KEY_DECLARATIONS, KEY_TYPE_STRING, KEY_TYPE_NUM, KEY_INPUT, KEY_OUTPUT};
}